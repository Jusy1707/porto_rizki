            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <ExternalLink className="relative w-4 h-4 md:w-5 md:h-5 group-hover:rotate- transition-transform" />
                ...
                >
                  ...
                  <Github className="relative w-4 h-4 md:w-5 md:h-5 group-hover:rotate- transition-transform" />
